...
export default function Home() {
  return (
    <div className="relative flex min-h-dvh flex-col overflow-x-hidden bg-brand-bg">
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-lg flex-1 flex-col gap-4 px-5 py-6">
        <section className="rounded-[1.75rem] border border-white/70 bg-white/90 p-6 shadow-[0_18px_50px_rgba(14,90,88,0.12)] backdrop-blur-sm">
          <ProcessInfo />
        </section>
      ...
      <footer className="relative z-10 px-5 pb-[max(1.25rem,env(safe-area-inset-bottom))] text-center">
